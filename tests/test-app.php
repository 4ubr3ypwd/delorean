...
class Test_App extends WP_UnitTestCase {
	...
	public function test_app_class_exists() {
		$this->assertTrue( class_exists( 'aubreypwd\Delorean\App' ), 'aubreypwd\Delorean\App class should always exist so we can create it.' );
	}
	...
	public function test_app_function() {
		$this->assertTrue( is_a( app(), 'aubreypwd\Delorean\App' ), 'app() should always be an instance of aubreypwd\Delorean\App.' );
	}
	...
	public function test_semver() {
		...
		// $this->assertTrue( version_compare( app()->version(), '0.0.0', '>=' ), 'Plugin version should always be semantic: 0.0.0 or 1.0 or 1.1.1, etc. Note, 1.0.0 will need to be replaced with a semantic value.' ); // @codingStandardsIgnoreLine
	}
	...
	public function test_app_properties() {
		...
		$this->assertNotEmpty( app()->plugin_file, 'App::plugin_file should always be set to the delorean.php file.' );
		...
		$this->assertNotEmpty( app()->path, 'App::path should always be set to the delorean.php file.' );
